...
export default ({ data }) => (
  <Layout>
    <p>
      ...
      My sculptures are fragmented as I am not seeking to capture a spirit or a moment in time, on the contrary – they are an invitation to the viewer, to move in and inhabit <em>their</em> world.
    </p><p>
...
export const query = graphql`
  query {
    file(relativePath: { eq: "wip-hare.jpg" }) {
      childImageSharp {
        fluid {
