...
export default () => (
  <Layout>
    ...
    <ul>
        <li>
          Solo Exhibition at Gallery 6, Newark-on-Trent.
        </li>
        <li>
          Great Northern Contemporary Craft Fair Online.
        </li>
        <li>
          Quarantine Craft Fair (online).
        </li>
    </ul>
    ...
    <ul>
        ...
        <li>
          Watermarks exhibition at the National Boat Museum , Ellesmere Port, with artists collective Markmakers.
        </li>
        <li>
          Bursary – Craft Potters Association.
        </li>
    </ul>
    ...
    <ul>
        <li>
          Manchester Art Fair, selected for the Manchester School of Art stand.
        </li>
        <li>
          MA Show, Manchester School of Art.
        </li>
        <li>
          London Road group show at Plant Noma, Manchester.
        </li>
    </ul>
